...
//var config = require('../websrc/app/config.js');
/*
 * Location of your backend server
 * Old url = 'https://stg.stellarex.com'
 */
var proxyTarget = 'https://dev.stellar.aero';
// var proxyTarget = 'http://192.168.99.99:8080';
...
function proxyMiddleware(req, res, next) {
   ...
   */
  if (/\.(html|css|js|png|jpg|jpeg|gif|ico|xml|rss|txt|eot|svg|ttf|woff|cur)(\?((r|v|rel|rev)=[\-\.\w]*)?)?$/.test(req.url) || req.url === '/' || req.headers.accept.indexOf('json') === -1) {
    next();
  } else {
    proxy.web(req, res);
  }
