...
gulp.task('init', ['sass', 'bower', 'js', 'image', 'image-min', 'html', 'index']);
...
gulp.task('bower', ['index', 'index:dist'], function() {
    return gulp.src(['./bower_components/**/*.js', './bower_components/**/*.min.css'])
...
gulp.task('dist:package', ['sass', 'bower', 'image', 'image-min', 'html', 'dist:iife', 'index:dist']);
